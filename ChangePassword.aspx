    ...
    <div class="login-form">
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <asp:TextBox CssClass="form-control" ID="tbPassword" placeholder="Current Password" runat="server" required="required" TextMode="Password"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:TextBox CssClass="form-control" onkeyup="javascript:validate()" ID="tbNewPassword" placeholder="New Password" runat="server" required="required" TextMode="Password"></asp:TextBox>
            ...
            <div class="clearfix">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UserProfile.aspx">Back</asp:HyperLink>
            </div>
            <div class="form-group">
                <br />
